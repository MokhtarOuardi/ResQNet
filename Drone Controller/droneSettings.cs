...
public class droneSettings {
    ...
    public static float constAxisIdealVelocity = 0.282393f;
    public static float constAxisIdealAcceler = 0.5510251f;

    public const float axisPID_P = 0.52663f;
    public const float axisPID_I = 0.09676E-05f;
    public const float axisPID_D = 0.02565225f;
    ...
    public const float orizPID_P = 0.12998019f;
    public const float orizPID_I = 3.116195E-05f;
    public const float orizPID_D = 0.003372454f;
